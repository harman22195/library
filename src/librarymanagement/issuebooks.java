...
class issuebooks
{
    ...
    void issue() throws Exception
    {
            ...
            FileReader file = new FileReader("C:\\Users\\Harman\\Desktop\\librarymanagement\\librarymanagement\\src\\librarymanagement\\bookmaster.txt");
            ...
            while((text = fileInput.readLine()) != null)        
                {
                    ...
                    if(status.equals("available"))
                    {
                        ...
                        if(choice==1)
                        {
                            ...
                            */
                            FileWriter fw = new FileWriter("C:\\Users\\Harman\\Desktop\\librarymanagement\\librarymanagement\\src\\librarymanagement\\bookmaster.txt");
